...
>                     sh "docker login -u $USERNAME -p $PASSWORD [Ip de Hots]:8083"
>                     sh "docker tag microservicio:latest [Ip de Hots]:8083/repository/docker-private/microservicio:latest"
